...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks']['ApacheSolrForTypo3\\Solrgeo\\Tasks\\GeoCoderTask'] = array(
	'extension'        => 'solr',
...
$GLOBALS['TYPO3_CONF_VARS']['SYS']['Objects']['\ApacheSolrForTypo3\Solr\Plugin\Results\SortingCommand'] = array(
	'className' => 'ApacheSolrForTypo3\\Solrgeo\\Search\\GeoSearchSortingCommand'
);
